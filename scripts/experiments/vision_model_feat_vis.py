...
def parse_arguments():
    ...
    parser.add_argument("--fourier_epochs", type=int, default=1000)
    parser.add_argument("--pii_epochs", type=int, default=250)
    parser.add_argument("--pii_fourier_epochs", type=int, default=500)
    parser.add_argument("--layer_name", type=str, default="features.3.0.mlp.2")
    parser.add_argument("--neuron_idx", type=int, default=11)
